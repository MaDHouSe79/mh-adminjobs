...
QBCore.Commands.Add('poljob', Lang:t('jobInfo.police'), {}, true, function(source) 
    SetJob(source, 'police', Config.JobBossRank.police) 
end, 'admin')

QBCore.Commands.Add('ambjob', Lang:t('jobInfo.ambulance'), {}, true, function(source) 
    SetJob(source, 'ambulance', Config.JobBossRank.ambulance) 
end, 'admin')

QBCore.Commands.Add('mechjob', Lang:t('jobInfo.mechanic'), {}, true, function(source) 
    SetJob(source, 'mechanic', Config.JobBossRank.mechanic) 
end, 'admin')

QBCore.Commands.Add('carjob', Lang:t('jobInfo.cardealer'), {}, true, function(source) 
    SetJob(source, 'cardealer', Config.JobBossRank.cardealer) 
end, 'admin')

QBCore.Commands.Add('realjob', Lang:t('jobInfo.realestate'), {}, true, function(source) 
    SetJob(source, 'realestate', Config.JobBossRank.realestate) 
end, 'admin')

QBCore.Commands.Add('onduty', Lang:t('jobInfo.onduty'), {}, false, function(source) 
    TriggerClientEvent("qb-adminjobs:client:ToggleDuty", source) 
end, 'admin')

QBCore.Commands.Add('offduty', Lang:t('jobInfo.offduty'), {}, false, function(source) 
    TriggerClientEvent("qb-adminjobs:client:ToggleDuty", source) 
end, 'admin')
